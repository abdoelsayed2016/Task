    ...
    <nav id="sidebar" class="sidebar-wrapper">
        <div class="sidebar-content">
          ...
          <span class="user-name">{{auth()->user()->name}}
                    ...
                    <span class="user-role">@if(auth()->user()->role==1) Administrator @else Student @endif</span>
                    ...
                    @if(auth()->user()->role==1)
                        ...
                        <li class="sidebar-dropdown">
                            ...
                            <div class="sidebar-submenu">
                                <ul>
                                    <li>
                                        <a href="{{route('semesters.index')}}">Index</a>
                                    </li>
                                    <li>
                                        <a href="{{route('semesters.create')}}">Create</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
                        <li class="sidebar-dropdown">
                            ...
                            <div class="sidebar-submenu">
                                <ul>
                                    <li>
                                        <a href="{{route('subjects.index')}}">Index</a>
                                    </li>
                                    <li>
                        ...
                        <li class="sidebar-dropdown">
                            <a href="#">
                                <i class="fa fa-shopping-cart"></i>
                                <span>Registeration & Mark</span>
                                <span class="badge badge-pill badge-danger"></span>
                            </a>
                            <div class="sidebar-submenu">
                                <ul>
                                    <li>
                                        <a href="{{route('registerations.index')}}">Index</a>
                                    </li>
                                    <li>
                                        <a href="{{route('registerations.create')}}">Create</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
                        <li class="sidebar-dropdown">
                            ...
                            <div class="sidebar-submenu">
                                <ul>
                                    <li>
                                        <a href="{{route('degrees.index')}}">Index</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
